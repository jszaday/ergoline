...
class UnparseAst extends EirVisitor[UnparseContext, String] {
  ...
  override def visitExpressionPattern(x: EirExpressionPattern)(implicit ctx: UnparseContext): String =
    visit(x.expression)
  ...
  override def visitConstantFacade(facade: EirConstantFacade)(implicit context: UnparseContext): String =
    visit(facade.value)
